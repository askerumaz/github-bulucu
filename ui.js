...
<div class="col-md-9">
    ...
    <span class="badge bg-info fs-6 mt-1">Takip Edenler:${user.following}</span>
    
    <ul class="list-group my-5">
        <li class="list-group-item">Hakkında:${user.bio}</li>
        <li class="list-group-item">Şirket:${user.conpany}</li>
...
repos.forEach((repo) => {
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <span class="badge bg-success">Fork'lar :${repo.fork_count}</span>
                </div>
            </div>
        </div>
            `;
